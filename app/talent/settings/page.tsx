...
export default function SettingsPage() {
    ...
    useEffect(() => {
        fetch("/api/user/profile")
            ...
            .then(d => {
                ...
                setLinkedinInput(tp.linkedinUrl || "");
    ...
    const saveLinkedin = async (url: string) => {
        ...
        const res = await fetch("/api/user/profile", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({ talentProfile: { linkedinUrl: url || null } }),
        });
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="rounded-2xl border overflow-hidden" style={{ background: 'var(--theme-card)', borderColor: 'var(--theme-border)' }}>
                            ...
                            {activeTab === "connections" && (
                                <div className="p-6 space-y-6">
                                    <Section title="Connections" desc="Link your LinkedIn profile to your SkillSpill account">
                                        {linkedinMsg && (
                                            <div className="rounded-xl px-4 py-3 text-[12px] font-medium"
                                                style={{
