...
const talentNavItems = [
    { label: "Home", icon: <HomeIcon />, href: "/talent" },
    { label: "Search", icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="11" cy="11" r="8" /><line x1="21" y1="21" x2="16.65" y2="16.65" /></svg>, href: "/talent/search" },
...
const mobileNavItems = [
    ...
    {
        label: "Search", href: "/talent/search",
            ...
            <aside className="hidden lg:flex w-[220px] flex-col shrink-0" style={{ background: 'var(--theme-surface)', borderRight: '1px solid var(--theme-border)' }}>
                ...
                <div className="p-4 space-y-3" style={{ borderTop: '1px solid var(--theme-border-light)' }}>
                    <div className="flex items-center gap-3">
                        {userData?.avatarUrl ? (
                            <img src={userData.avatarUrl} alt={username} className="w-9 h-9 rounded-full object-cover shrink-0" style={{ border: `1px solid ${accent}40` }} />
                        ) : (
                            <div
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                ...
                <header className="shrink-0 h-12 flex items-center gap-3 px-3 lg:hidden" style={{ background: 'var(--theme-surface)', borderBottom: '1px solid var(--theme-border)' }}>
                    ...
                    <Link href="/talent/profile" className="shrink-0">
                        {userData?.avatarUrl ? (
                            <img src={userData.avatarUrl} alt={username} className="w-8 h-8 rounded-full object-cover shadow-sm border-2" style={{ borderColor: `${accent}40` }} />
                        ) : (
                            <div
                    ...
                    {/* Search bar */}
                    <Link href="/talent/search" className="flex-1 flex items-center gap-2 rounded-lg px-3 py-1.5 no-underline" style={{ background: 'var(--theme-input-bg)' }}>
                        ...
                        <input
                            ...
                            placeholder="Search"
                            readOnly
                            className="flex-1 bg-transparent border-none outline-none text-[13px] cursor-pointer"
                    ...
                    <div className="flex items-center gap-3 shrink-0">
                        ...
                        <Link href="/talent/messages" className="relative transition-colors" style={{ color: 'var(--theme-text-muted)' }}>
                ...
                <header className="shrink-0 h-14 hidden lg:flex items-center justify-between px-6 backdrop-blur-xl z-30" style={{ background: 'var(--theme-header-bg)', borderBottom: '1px solid var(--theme-border)' }}>
                    {/* Search bar */}
                    <Link href="/talent/search" className="flex items-center gap-2 rounded-xl px-3.5 py-2 focus-within:border-[#3CF91A] focus-within:ring-2 focus-within:ring-[#3CF91A]/10 transition-all max-w-[360px] w-full no-underline" style={{ background: 'var(--theme-input-bg)', border: '1px solid var(--theme-border)' }}>
                        ...
                        <input
                            ...
                            readOnly
                            className="flex-1 bg-transparent border-none outline-none text-[12px] cursor-pointer"
                            style={{ color: 'var(--theme-text-primary)' }}
                        />
                    </Link>
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                        ...
                        <div className="relative" ref={dropdownRef}>
                            ...
                            >
                                {userData?.avatarUrl ? (
                                    <img src={userData.avatarUrl} alt={username} className="w-8 h-8 rounded-full object-cover shadow-sm border border-black/10" />
                                ) : (
                            ...
                            {profileDropdown && (
                                <div className="absolute right-0 top-12 w-52 rounded-xl shadow-xl py-1.5 z-50" style={{ background: 'var(--theme-surface)', border: '1px solid var(--theme-border)' }}>
                                    <div className="px-4 py-3" style={{ borderBottom: '1px solid var(--theme-border-light)' }}>
                                        <div className="flex items-center gap-3">
                                            {userData?.avatarUrl ? (
                                                <img src={userData.avatarUrl} alt={username} className="w-9 h-9 rounded-full object-cover border border-black/10" />
                                            ) : (
