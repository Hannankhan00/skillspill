                ...
                <div className="max-w-2xl mx-auto px-4">
                    <div className="h-14 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            <button
                                onClick={() => router.back()}
                                className="w-8 h-8 rounded-xl flex items-center justify-center hover:bg-(--theme-input-bg) transition-all bg-transparent border-none cursor-pointer"
                    ...
                    <div className="mb-4 space-y-3">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-9 pr-4 py-2.5 rounded-xl text-[12px] bg-(--theme-input-bg) border border-(--theme-border) outline-none focus:border-[#8B5CF6] transition-all"
                            ...
                            {typeFilters.map(f => (
                                <button
                                    ...
                                    className={`flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-[10px] font-semibold border cursor-pointer transition-all shrink-0 ${filterType === f.key
                                        ? "shadow-sm"
                                        : "bg-transparent hover:bg-(--theme-input-bg)"
                                        }`}
                                    style={{
                ...
                {!loading && posts.length > 0 && filteredPosts.length === 0 && (
                    <div className="rounded-2xl border p-8 text-center" style={{ borderColor: "var(--theme-border)", background: "var(--theme-card)" }}>
                        ...
                        <button
                            ...
                            className="px-4 py-2 rounded-xl text-[11px] font-bold border cursor-pointer transition-all bg-transparent hover:bg-(--theme-input-bg)"
