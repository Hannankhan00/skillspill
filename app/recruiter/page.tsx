                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1">
                                    <textarea
                                        ...
                                        className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-[13px] text-gray-700 placeholder:text-gray-400 resize-none outline-none focus:border-purple-300 focus:ring-2 focus:ring-purple-50 transition-all"
                                        rows={2}
                                    />
                                    <div className="flex items-center justify-between mt-3">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <button className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[11px] font-medium text-purple-400 hover:text-purple-600 hover:bg-purple-50 transition-all bg-transparent border-none cursor-pointer">
                            ...
                            return (
                                <article key={post.id} className="rounded-2xl border border-gray-200 bg-white shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden">
                                    ...
                                    <div className="flex items-center justify-between px-5 pt-4 pb-2">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <div className="flex items-center gap-1.5">
                                                    ...
                                                    {post.matchScore && (
                                                        <span className="text-[9px] px-1.5 py-0.5 rounded-full bg-purple-50 text-purple-600 border border-purple-100 font-bold"
                                        ...
                                        <div className="flex items-center gap-2">
                                            {post.matchScore && (
                                                <button className="px-3 py-1 rounded-lg text-[10px] font-bold text-purple-600 border border-purple-200 bg-purple-50 cursor-pointer hover:bg-purple-600 hover:text-white hover:border-purple-600 transition-all">
                                                    Connect
                                                </button>
                                            )}
                                    ...
                                    <div className="flex flex-wrap gap-1.5 px-5 pb-3">
                                        {post.tags.map((tag) => (
                                            <span key={tag} className="text-[10px] px-2 py-0.5 rounded-md bg-gray-50 border border-gray-200 text-gray-500 font-medium cursor-pointer hover:border-purple-300 hover:text-purple-600 hover:bg-purple-50 transition-all"
                                                style={{ fontFamily: "var(--font-jetbrains-mono)" }}>
                                                #{tag}
                                            </span>
                                        ))}
                                    ...
                                    <div className="flex items-center justify-between px-5 py-3 border-t border-gray-100">
                                        <div className="flex items-center gap-5">
                                            ...
                                            <button className="flex items-center gap-1.5 text-[12px] font-medium text-gray-400 hover:text-purple-500 transition-all bg-transparent border-none cursor-pointer">
                    ...
                    <div className="hidden lg:block w-[300px] shrink-0 space-y-5">
                        ...
                        <div className="rounded-2xl border border-gray-200 bg-white shadow-sm overflow-hidden">
                            ...
                            <div className="px-4 pb-4 -mt-6">
                                ...
                                <h3 className="text-[14px] font-bold text-gray-800 mt-2">Recruiter</h3>
                                <p className="text-[11px] text-gray-400 mb-3">Talent Scout • SkillSpill</p>
                                <div className="grid grid-cols-3 gap-2 text-center">
                                    <div className="bg-purple-50 rounded-lg py-2">
                                        <p className="text-[14px] font-bold text-purple-600">3</p>
                                        <p className="text-[8px] text-gray-400 uppercase tracking-wider font-semibold">Jobs</p>
                                    </div>
                                    <div className="bg-indigo-50 rounded-lg py-2">
                                        <p className="text-[14px] font-bold text-indigo-600">38</p>
                                        <p className="text-[8px] text-gray-400 uppercase tracking-wider font-semibold">Applicants</p>
                                    </div>
                                    <div className="bg-emerald-50 rounded-lg py-2">
                                        <p className="text-[14px] font-bold text-emerald-600">2</p>
                                        <p className="text-[8px] text-gray-400 uppercase tracking-wider font-semibold">Hires</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="rounded-2xl border border-gray-200 bg-white shadow-sm overflow-hidden">
                            <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100">
                                ...
                                <Link href="/recruiter/bounties"
                                    className="text-[9px] text-purple-500 hover:text-purple-600 font-bold no-underline transition-colors">
                                    MANAGE →
                                </Link>
                            </div>
                            <div className="divide-y divide-gray-50">
                                {activeJobs.map((job, i) => (
                                    <div key={i} className="px-4 py-3 hover:bg-purple-50/30 transition-colors cursor-pointer group">
                                        ...
                                        <div className="flex items-center justify-between">
                                            <span className="text-[10px] text-gray-400">{job.apps} applicants • {job.type}</span>
                                            <span className={`text-[10px] ${job.days <= 3 ? "text-orange-500 font-semibold" : "text-gray-400"}`}
                            ...
                            <div className="px-4 py-3 border-t border-gray-100">
                                <Link href="/recruiter/bounties"
                                    className="flex items-center justify-center gap-2 w-full py-2 rounded-xl text-[11px] font-bold text-purple-600 bg-purple-50 border border-purple-100 hover:bg-purple-600 hover:text-white hover:border-purple-600 transition-all no-underline cursor-pointer">
                                    + Post New Job
                                </Link>
                            </div>
                        </div>
                        ...
                        <div className="rounded-2xl border border-gray-200 bg-white shadow-sm overflow-hidden">
                            ...
                            <div className="divide-y divide-gray-50">
                                {topCandidates.map((c) => (
                                    <div key={c.name} className="flex items-center justify-between px-4 py-3 hover:bg-gray-50 transition-colors">
                                        <div className="flex items-center gap-2.5">
                                            ...
                                            <div>
                                                <p className="text-[12px] font-semibold text-gray-700">{c.name}</p>
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <button className="px-2.5 py-1 rounded-md text-[9px] font-bold text-purple-600 border border-purple-200 bg-purple-50 cursor-pointer hover:bg-purple-600 hover:text-white hover:border-purple-600 transition-all">
                                                View
                                            </button>
                                        </div>
                                    </div>
