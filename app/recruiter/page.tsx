...
/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
   S K I L L S P I L L  â€”  R E C R U I T E R  F E E D
   Social feed â€” recruiter perspective
   â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1">
                                    <textarea
                                        ...
                                        className="w-full bg-[var(--theme-bg-secondary)] border border-[var(--theme-border)] rounded-xl px-4 py-3 text-[13px] text-[var(--theme-text-secondary)] placeholder:text-[var(--theme-text-muted)] resize-none outline-none focus:border-purple-300 focus:ring-2 focus:ring-purple-50 transition-all"
                                        rows={2}
                                    />
                            ...
                            return (
                                <article key={post.id} className="rounded-2xl border border-[var(--theme-border)] bg-[var(--theme-card)] shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden">
                                    ...
                                    <div className="flex flex-wrap gap-1.5 px-5 pb-3">
                                        {post.tags.map((tag) => (
                                            <span key={tag} className="text-[10px] px-2 py-0.5 rounded-md bg-[var(--theme-bg-secondary)] border border-[var(--theme-border)] text-[var(--theme-text-muted)] font-medium cursor-pointer hover:border-purple-300 hover:text-purple-600 hover:bg-purple-50 transition-all"
                                                style={{ fontFamily: "var(--font-jetbrains-mono)" }}>
                                                #{tag}
                                            </span>
                                        ))}
                                    ...
                                    <div className="flex items-center justify-between px-5 py-3 border-t border-[var(--theme-border-light)]">
                                        <div className="flex items-center gap-5">
                                            ...
                                            <button className="flex items-center gap-1.5 text-[12px] font-medium text-[var(--theme-text-muted)] hover:text-purple-500 transition-all bg-transparent border-none cursor-pointer">
                    ...
                    <div className="hidden lg:block w-[300px] shrink-0 space-y-5">
                        ...
                        <div className="rounded-2xl border border-[var(--theme-border)] bg-[var(--theme-card)] shadow-sm overflow-hidden">
                            ...
                            <div className="px-4 pb-4 -mt-6">
                                ...
                                <p className="text-[11px] text-[var(--theme-text-muted)] mb-3">Talent Scout â€¢ SkillSpill</p>
                        ...
                        <div className="rounded-2xl border border-[var(--theme-border)] bg-[var(--theme-card)] shadow-sm overflow-hidden">
                            <div className="flex items-center justify-between px-4 py-3 border-b border-[var(--theme-border-light)]">
                                <h3 className="text-[11px] font-bold text-[var(--theme-text-muted)] uppercase tracking-[2px]"
                                    style={{ fontFamily: "var(--font-jetbrains-mono)" }}>ðŸ’¼ Your Jobs</h3>
                                ...
                                {activeJobs.map((job, i) => (
                                    <div key={i} className="px-4 py-3 hover:bg-purple-50/30 transition-colors cursor-pointer group">
                                        ...
                                        <div className="flex items-center justify-between">
                                            <span className="text-[10px] text-[var(--theme-text-muted)]">{job.apps} applicants â€¢ {job.type}</span>
                        ...
                        <div className="rounded-2xl border border-[var(--theme-border)] bg-[var(--theme-card)] shadow-sm overflow-hidden">
                            <div className="flex items-center justify-between px-4 py-3 border-b border-[var(--theme-border-light)]">
                                <h3 className="text-[11px] font-bold text-[var(--theme-text-muted)] uppercase tracking-[2px]"
                                    style={{ fontFamily: "var(--font-jetbrains-mono)" }}>ðŸŽ¯ Top Matches</h3>
                        ...
                        {/* â”€â”€ Skill Demand â”€â”€ */}
                        <div className="rounded-2xl border border-[var(--theme-border)] bg-[var(--theme-card)] shadow-sm overflow-hidden">
                            <div className="px-4 py-3 border-b border-[var(--theme-border-light)]">
                                <h3 className="text-[11px] font-bold text-[var(--theme-text-muted)] uppercase tracking-[2px]"
                                    style={{ fontFamily: "var(--font-jetbrains-mono)" }}>ðŸ“Š Skill Demand</h3>
                            </div>
